...
public class LemasConfig {
	
	public static final String crawlStorageFolder = "/tmp";
	public static int numberOfCrawlers = 100;
	...
	public static String path = MLFeedback.folder + File.separatorChar + "feedbacks";
